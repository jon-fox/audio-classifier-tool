...
- `PAYLOAD='{"podcast_name": ..., "episode_name": ..., "audio_url": ...}' uv run audioclassifier --detection examples/configs/ads.toon` — process one episode (needs `OPENAI_API_KEY`, `ffmpeg`)
