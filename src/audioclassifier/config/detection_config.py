...
# Named configs resolve from ./configs first, then the ones bundled with the package
CONFIGS_DIR = os.path.join(os.getcwd(), "configs")
_PACKAGE_CONFIGS_DIR = os.path.join(
...
def _resolve_path(name_or_path):
    if os.path.isfile(name_or_path):
        return name_or_path
    candidates = [
        os.path.join(CONFIGS_DIR, f"{name_or_path}.toon"),
        os.path.join(_PACKAGE_CONFIGS_DIR, f"{name_or_path}.toon"),
    ]
